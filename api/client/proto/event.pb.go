...
import (
	...
	v118 "github.com/gravitational/teleport/api/gen/proto/go/teleport/processhealth/v1"
...
func (x *Event) GetProcessHealth() *v118.ProcessHealth {
	if x != nil {
		if x, ok := x.Resource.(*Event_ProcessHealth); ok {
...
type Event_ProcessHealth struct {
	// UserTask is a resource for user task.
	ProcessHealth *v118.ProcessHealth `protobuf:"bytes,82,opt,name=ProcessHealth,proto3,oneof"`
}
...
func (*Event_ProcessHealth) isEvent_Resource() {}
...
const file_teleport_legacy_client_proto_event_proto_rawDesc = "" +
	...
	"ScopedRole\x12e\n" +
	"\x14ScopedRoleAssignment\x18Q \x01(\v2/.teleport.scopes.access.v1.ScopedRoleAssignmentH\x00R\x14ScopedRoleAssignment\x12P\n" +
	"\rProcessHealth\x18R \x01(\v2(.teleport.processhealth.v1.ProcessHealthH\x00R\rProcessHealthB\n" +
	"\n" +
...
var file_teleport_legacy_client_proto_event_proto_goTypes = []any{
	...
	(*v118.ProcessHealth)(nil),                  // 75: teleport.processhealth.v1.ProcessHealth
}
var file_teleport_legacy_client_proto_event_proto_depIdxs = []int32{
	...
	75, // 77: proto.Event.ProcessHealth:type_name -> teleport.processhealth.v1.ProcessHealth
