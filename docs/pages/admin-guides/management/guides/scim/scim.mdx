...
- Role assignments are handled in Teleport, while group membership is deleted to External Identity Management System (like SailPoint).
...
- Copy the **Client ID**, **Client Secret**, and **Base URL** — you'll use them
  when configuring your Identity Provider In next step.
...
- In case of Other SCIM providers, please refer to their documentation for SCIM integration.
