---
title: Sailpoint SCIM Integration
description: How to setup SCIM Sailpoint integration to manage Access List membership

---

## Configure SCIM 2.0 Teleport Connector in SailPoint
...
#### Submit Access Requests to Sailpoint ACL Group Entitlement (Optional)
...
- [Integrating SailPoint with SCIM 2.0](https://documentation.sailpoint.com/connectors/scim_2_0/help/integrating_scim2/introduction.html)
