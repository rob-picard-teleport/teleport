...
<!-- TODO: insert graphic of “before.” Cluster is publicly exposed, secrets in the pipeline.-->
...
Todo: insert graphic of “after.” Cluster is private, no secrets.

Get started securing your CI/CD pipelines:

<!-- TODO: 
Insert: links/cards to the various CI/CD integration pages  
Insert: links/cards to various resource access pages -->
