...
A Teleport instance that runs one or more services to provide access to multiple resources. 
...
The Teleport Terraform Provider allows you to manage Teleport resourcess such as users, roles, and connectors using Terraform. 
